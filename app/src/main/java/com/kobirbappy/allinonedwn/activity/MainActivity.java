...
import com.kobirbappy.allinonedwn.databinding.ActivityMainBinding;
import com.kobirbappy.allinonedwn.util.AppLangSessionManager;
import com.kobirbappy.allinonedwn.util.ClipboardListener;
...
//        });
    ...
    public void callFacebookActivity() {
        Intent i = new Intent(activity, fbActivity.class);
    ...
    public void onBackPressed() {
        ...
        setToast(activity, getResources().getString(R.string.pls_bck_again));
