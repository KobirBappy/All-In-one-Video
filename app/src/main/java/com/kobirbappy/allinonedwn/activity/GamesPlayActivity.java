...
import com.kobirbappy.allinonedwn.databinding.ActivityGamesPlayBinding;
...
public class GamesPlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (intentUrl.equals("clumsybird")) {
            webView.loadUrl("file:///android_asset/clumsybird/index.html");
        }
