...
import com.kobirbappy.allinonedwn.databinding.ActivityAllGamesBinding;
...
//        binding.webgame3.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent i = new Intent(activity, GamesPlayActivity.class);
//                i.putExtra("url","clumsybird");
...
//            }
//        });
//        binding.webgabe4.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent i = new Intent(activity, GamesPlayActivity.class);
//                i.putExtra("url","Helix");
